<?php
/**
 * Mobile News Schema.org Implementation
 */
 ...
 */
function mobilenews_output_schema()
{
    if (is_single()) {
        mobilenews_single_post_schema();
    }
    mobilenews_website_schema();
}
add_action('wp_head', 'mobilenews_output_schema');

/**
 * NewsArticle Schema for Single Posts
 */
function mobilenews_single_post_schema()
{
    global $post;
    $schema = array(
 ...
 */
function mobilenews_website_schema()
{
 ...
 */
function mobilenews_breadcrumb_schema()
{
    $items = array();
