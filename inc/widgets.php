 ...
 * Weather Widget
 */
class MobileNews_Weather_Widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'mobilenews_weather_widget',
            __('Mobile News: Weather', 'mobilenews'),
            array('description' => __('Displays current weather information based on user location or default city.', 'mobilenews'))
        );
    }
    ...
    {
        $title = !empty($instance['title']) ? $instance['title'] : __('Weather', 'mobilenews');
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
                <?php esc_html_e('Title:', 'mobilenews'); ?>
            </label>
        ...
        <p class="description">
            <?php esc_html_e('Configurations like API Key and Default Location are managed in Theme Options.', 'mobilenews'); ?>
        </p>
        <?php
    }
 ...
 */
class MobileNews_Trending_Widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'mobilenews_trending_widget',
            __('Mobile News: Trending Posts', 'mobilenews'),
            array('description' => __('Displays most commented posts with a numbered list design.', 'mobilenews'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        $title = !empty($instance['title']) ? $instance['title'] : __('Trending', 'mobilenews');
        ...
        if ($trending_query->have_posts()):
            ...
            echo '<p>' . __('No trending posts found.', 'mobilenews') . '</p>';
        endif;
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('count')); ?>">
                <?php esc_html_e('Number of posts to show:', 'mobilenews'); ?>
            </label>
...
/**
 * Mobile News List Widget (Recent/Category with Thumbnails)
 */
class MobileNews_Post_List_Widget extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'mobilenews_post_list_widget',
            __('Mobile News: Post List', 'mobilenews'),
            array('description' => __('Displays a list of posts with thumbnails. Useful for Recent News or Category specific lists.', 'mobilenews'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        $title = !empty($instance['title']) ? $instance['title'] : __('Recent News', 'mobilenews');
        $count = !empty($instance['count']) ? absint($instance['count']) : 5;
        ...
        if ($list_query->have_posts()):
                ...
                <div class="flex gap-4 group cursor-pointer items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <span class="text-[10px] text-gray-400 mt-1 block">
                            <?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . __('ago', 'mobilenews'); ?>
                        </span>
                    </div>
                </div>
                <?php
            ...
            echo '<p>' . __('No posts found.', 'mobilenews') . '</p>';
        endif;
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('count')); ?>">
                <?php esc_html_e('Number of posts:', 'mobilenews'); ?>
            </label>
            <input class="tiny-text" id="<?php echo esc_attr($this->get_field_id('count')); ?>"
                name="<?php echo esc_attr($this->get_field_name('count')); ?>" type="number" step="1" min="1"
                value="<?php echo esc_attr($count); ?>" size="3">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('category')); ?>">
                <?php esc_html_e('Filter by Category (Optional):', 'mobilenews'); ?>
            </label>
            <?php
            wp_dropdown_categories(array(
                'show_option_all' => __('All Categories', 'mobilenews'),
...
/**
 * Mobile News: Author Bio Widget
 */
class MobileNews_Author_Widget extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'mobilenews_author_widget',
            __('Mobile News: Author Bio', 'mobilenews'),
            array('description' => __('Displays the post author bio with social links.', 'mobilenews'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        <div class="author-widget-premium flex flex-col items-center text-center">
            ...
            <p class="text-[10px] text-primary font-black uppercase tracking-[0.2em] mb-4"><?php echo esc_html__('Verified Author', 'mobilenews'); ?></p>
...
/**
 * Mobile News: Newsletter Widget
 */
class MobileNews_Newsletter_Widget extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'mobilenews_newsletter_widget',
            __('Mobile News: Newsletter', 'mobilenews'),
            array('description' => __('Premium newsletter sign-up form.', 'mobilenews'))
        );
    }
...
/**
 * Mobile News: Social Follow Widget
 */
class MobileNews_Social_Follow_Widget extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'mobilenews_social_follow_widget',
            __('Mobile News: Social Follow', 'mobilenews'),
            array('description' => __('Elegant social media follow buttons.', 'mobilenews'))
        );
    }
