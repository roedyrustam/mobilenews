<?php
/**
 * Template Name: Live Streaming (Theme Integrated)
 */
...
if (!$live_is_active && function_exists('mobilenews_is_youtube_live')) {
    $live_is_active = mobilenews_is_youtube_live();
}
    ...
    <main id="main-content" class="max-w-[1440px] mx-auto px-4 lg:px-10 py-10 relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between py-10 gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <?php if (function_exists('get_template_part')) get_template_part('template-parts/social-share'); ?>
            </div>
        </div>
