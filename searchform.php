...
<form role="search" method="get" class="relative flex items-center w-full"
    ...
    <label for="search-field-<?php echo uniqid(); ?>"
        class="sr-only"><?php echo _x('Search for:', 'label', 'mobilenews'); ?></label>
    <input type="search" id="search-field-<?php echo uniqid(); ?>"
        ...
        placeholder="<?php echo esc_attr_x('Cari berita...', 'placeholder', 'mobilenews'); ?>"
        value="<?php echo get_search_query(); ?>" name="s"
        aria-label="<?php echo esc_attr_x('Search terms', 'aria label', 'mobilenews'); ?>" />
    <button type="submit" aria-label="<?php echo esc_attr_x('Submit Search', 'aria label', 'mobilenews'); ?>"
