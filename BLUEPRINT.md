# Mobile News Theme - Architecture Blueprint
...
```mermaid
classDiagram
    WP_Widget <|-- MobileNews_Weather_Widget
    WP_Widget <|-- MobileNews_Trending_Widget
    WP_Widget <|-- MobileNews_Post_List_Widget
    
    class MobileNews_Weather_Widget{
        +widget()
        +form()
        +update()
    }
    
    class MobileNews_Trending_Widget{
        +widget()
        +form()
        +update()
        -count: int
    ...
    class MobileNews_Post_List_Widget{
        +widget()
        +form()
        +update()
        -count: int
...
| Option Key | Purpose |
|------------|---------|
| `mobilenews_theme_options` | Serialized theme settings array |
...
|--------|---------|---------|
| `get_local_news` | `mobilenews_get_local_news()` | Fetch posts by city tag/category |
| `mobilenews_load_more_posts` | `inc/ajax-archive.php` | Paginated post loading |
